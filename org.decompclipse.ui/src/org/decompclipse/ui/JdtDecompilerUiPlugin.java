...
public class JdtDecompilerUiPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.decompclipse.ui";

	public static final String PREF_USE_ECLIPSE_FORMATTER = "org.decompclipse.use_eclipse_formatter";

	public static final String PREF_DECOMPILER = "org.decompclipse.decompiler";
	...
	protected void initializeDefaultPreferences(IPreferenceStore store) {
		...
		store.setDefault(PREF_DECOMPILER, "org.decompclipse.jad.JadDecompiler");
	}
